...
public:
    GeneralLevel(const std::filesystem::path& path, size_t max_file_size, size_t max_num_files);
...
private:
    ...
    mutable std::list<SSTFile> lru_sst_files_; // Least Recently Used cache for SST files
